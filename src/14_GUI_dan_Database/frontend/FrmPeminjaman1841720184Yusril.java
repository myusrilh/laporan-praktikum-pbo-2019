...
public class FrmPeminjaman1841720184Yusril extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman1841720184Yusril
     */
    public FrmPeminjaman1841720184Yusril() {
        initComponents();
        tampilData();
        kosongkanForm();
    }
    ...
    public void tampilData() {
        String[] kolom = {"ID", "Peminjam", "Judul Buku1841720184Yusril", "TanggalPinjam", "Tanggal Kembali"};
        ArrayList<Peminjaman1841720184Yusril> list = new Peminjaman1841720184Yusril().getAllYusril();
        Object[] rowData = new Object[5];

        this.tblPeminjaman.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getIdpeminjamanYusril();
            rowData[1] = list.get(i).getAnggotaYusril().getNamaYusril();
            rowData[2] = list.get(i).getBukuYusril().getJudulYusril();
            rowData[3] = list.get(i).getTanggalPinjamYusril();
            rowData[4] = list.get(i).getTanggalKembaliYusril();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720184Yusril pinjam = new Peminjaman1841720184Yusril().getByIdYusril(Integer.parseInt(this.txtId.getText()));
        pinjam.setAnggotaYusril(new Anggota1841720184Yusril().getByIdYusril(Integer.parseInt(this.txtIdAnggota.getText())));
        pinjam.setBukuYusril(new Buku1841720184Yusril().getByIdYusril(Integer.parseInt(this.txtIdBuku.getText())));
        pinjam.setTanggalPinjamYusril(this.txtTanggalPinjam.getText());
        pinjam.setTanggalKembaliYusril(this.txtTanggalKembali.getText());
        pinjam.saveYusril();
        tampilData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720184Yusril pinjam = new Peminjaman1841720184Yusril().getByIdYusril(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pinjam.deleteYusril();
        kosongkanForm();
        tampilData();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        ...
        pinjam.cariAnggotaYusril(Integer.parseInt(this.txtIdAnggota.getText()));
        this.jLabel6.setText((pinjam.getAnggotaYusril().getNamaYusril()));
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBukuActionPerformed
        Peminjaman1841720184Yusril pinjam = new Peminjaman1841720184Yusril();
        pinjam.cariBukuYusril(Integer.parseInt(this.txtIdBuku.getText()));
        this.jLabel7.setText((pinjam.getBukuYusril().getJudulYusril()));
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = this.tblPeminjaman.getSelectedRow();
        Peminjaman1841720184Yusril pinjam = new Peminjaman1841720184Yusril().getByIdYusril(Integer.parseInt(model.getValueAt(row, 0).toString()));
        this.txtId.setText(String.valueOf(pinjam.getIdpeminjamanYusril()));

        this.txtIdAnggota.setText(String.valueOf(pinjam.getIdanggotaYusril()));
        this.txtIdBuku.setText(String.valueOf(pinjam.getIdbukuYusril()));

        this.txtTanggalPinjam.setText(String.valueOf(pinjam.getTanggalPinjamYusril()));

        this.txtTanggalKembali.setText(String.valueOf(pinjam.getTanggalKembaliYusril()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720184Yusril.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720184Yusril().setVisible(true);
            }
        });
    }
